...
namespace MCSong
{
    public class Extension
    {
        ...
        public static readonly ExtensionList support = new ExtensionList();
        ...
        public static readonly Extension HackControl = new Extension("HackControlDialog", 1);
        ...
        public static bool supported(Extension e) { return support.Contains(e); }
        public static bool enabled(Extension e) { return Server.cpe.Contains(e); }
        public bool supported() { return support.Contains(this); }
        ...
        {
            support.Add(ClickDistance);
            support.Add(CustomBlocks);
            support.Add(HackControl);
        }
    }
