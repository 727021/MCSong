        ...
        static IsoCat()
        {
            ...
            if (!File.Exists("extra/Tileset.png"))
                using (WebClient w = new WebClient())
                    w.DownloadFile("http://updates.mcsong.x10.mx/Tileset.png", "extra/Tileset.png");
            if (!File.Exists("extra/TilesetShadowed.png"))
                using (WebClient w = new WebClient())
                    w.DownloadFile("http://updates.mcsong.x10.mx/TilesetShadowed.png", "extra/TilesetShadowed.png");
